    ...
    public class ConstructionSiteCalculationView
    {
        public static void CreateView()
        {
            ...
            strSQLCommand =
                ...
                "constructionSiteCalculation.NumOfEmployees, constructionSiteCalculation.EmployeePrice, constructionSiteCalculation.NumOfMonths, constructionSiteCalculation.OldValue, constructionSiteCalculation.NewValue, constructionSiteCalculation.ValueDifference," +
                "constructionSiteCalculation.PlusMinus, constructionSiteCalculation.ItemStatus, constructionSiteCalculation.IsPaid, constructionSiteCalculation.IsRefunded, constructionSiteCalculation.DateCondition, " +
