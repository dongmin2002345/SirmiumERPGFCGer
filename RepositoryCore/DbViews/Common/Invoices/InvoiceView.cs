    ...
    public class InvoiceView
    {
        public static void CreateView()
        {
            ...
            strSQLCommand =
                ...
                "vat.Id AS VatId, vat.Identifier AS VatIdentifier, vat.Code AS VatCode, vat.Amount AS VatAmount, vat.Description AS VatDescription, " +
                ...
                "invoice.Currency, invoice.Active AS Active," +
