    ...
    public class BusinessPartnerPhoneView
    {
        public static void CreateView()
        {
            ...
            strSQLCommand =
                ...
                "businessPartnerPhone.Phone, businessPartnerPhone.Mobile, businessPartnerPhone.Fax, businessPartnerPhone.Email, businessPartnerPhone.ContactPersonFirstName, businessPartnerPhone.ContactPersonLastName, businessPartnerPhone.Birthday, businessPartnerPhone.Description, businessPartnerPhone.Path, businessPartnerPhone.ItemStatus, businessPartnerPhone.Active AS Active, " +
