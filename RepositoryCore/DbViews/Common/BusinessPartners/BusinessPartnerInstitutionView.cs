    ...
    public class BusinessPartnerInstitutionView
    {
        public static void CreateView()
        {
            ...
            strSQLCommand =
                ...
                "businessPartnerInstitution.Code, businessPartnerInstitution.Institution, businessPartnerInstitution.Username, businessPartnerInstitution.Password, businessPartnerInstitution.ContactPerson, businessPartnerInstitution.Phone, businessPartnerInstitution.Fax, businessPartnerInstitution.Email, businessPartnerInstitution.Note, businessPartnerInstitution.ItemStatus, businessPartnerInstitution.Active AS Active, " +
