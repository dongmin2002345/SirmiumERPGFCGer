    ...
    public class BusinessPartnerView
    {
        public static void CreateView()
        {
            ...
            strSQLCommand =
                ...
                "(SELECT MAX(v) FROM (VALUES (businessPartner.UpdatedAt), (taxAdministration.UpdatedAt), (country.UpdatedAt), (sector.UpdatedAt), (agency.UpdatedAt), (countrySrb.UpdatedAt), (citySrb.UpdatedAt)) AS value(v)) AS UpdatedAt, " +
