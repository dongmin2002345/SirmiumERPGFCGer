...
namespace RepositoryCore.Migrations
{
    ...
    [Migration("20200411114624_DocumentStores-Novo")]
    partial class DocumentStoresNovo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DomainCore.CalendarAssignments.CalendarAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DomainCore.Common.BusinessPartners.BusinessPartner", b =>
                {
                    ...
                    b.HasIndex("CitySrbId");

                    b.HasIndex("CompanyId");

                    b.HasIndex("CountryId");

                    b.HasIndex("CountrySrbId");
            ...
            modelBuilder.Entity("DomainCore.Common.CallCentars.CallCentar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DomainCore.Common.DocumentStores.DocumentFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DomainCore.Common.DocumentStores.DocumentFolder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DomainCore.Common.Invoices.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<double>("TotalPDV");

                    b.Property<double>("TotalPrice");

                    b.Property<double>("TotalRebate");
            ...
            modelBuilder.Entity("DomainCore.Common.Invoices.InvoiceItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<decimal>("PDVPercent");

                    b.Property<decimal>("PriceWithPDV");

                    b.Property<decimal>("PriceWithoutPDV");
            ...
            modelBuilder.Entity("DomainCore.Common.Phonebooks.Phonebook", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DomainCore.Common.Phonebooks.PhonebookDocument", b =>
                {
                    ...
                    b.ToTable("PhonebookDocuments");
                });

            modelBuilder.Entity("DomainCore.Common.Phonebooks.PhonebookNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("PhonebookNotes");
                });

            modelBuilder.Entity("DomainCore.Common.Phonebooks.PhonebookPhone", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DomainCore.Employees.EmployeeAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DomainCore.Employees.PhysicalPersonAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("PhysicalPersonAttachments");
                });
            ...
            modelBuilder.Entity("DomainCore.CalendarAssignments.CalendarAssignment", b =>
                {
                    b.HasOne("DomainCore.Common.Identity.User", "AssignedTo")
                        .WithMany()
            ...
            modelBuilder.Entity("DomainCore.Common.BusinessPartners.BusinessPartner", b =>
                {
                    ...
                    b.HasOne("DomainCore.Common.Locations.City", "CitySrb")
                        .WithMany()
                        .HasForeignKey("CitySrbId");
                    ...
                    b.HasOne("DomainCore.Common.Locations.Country", "CountrySrb")
                        .WithMany()
                        .HasForeignKey("CountrySrbId");

                    b.HasOne("DomainCore.Common.Identity.User", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("CreatedById");

                    b.HasOne("DomainCore.Common.Prices.Discount", "Discount")
                        .WithMany()
                    ...
                    b.HasOne("DomainCore.Vats.Vat", "Vat")
                        .WithMany()
                        .HasForeignKey("VatId");
                });
            ...
            modelBuilder.Entity("DomainCore.Common.DocumentStores.DocumentFile", b =>
                {
                    ...
                    b.HasOne("DomainCore.Common.DocumentStores.DocumentFolder", "DocumentFolder")
                        .WithMany()
            ...
            modelBuilder.Entity("DomainCore.Common.DocumentStores.DocumentFolder", b =>
                {
                    ...
                    b.HasOne("DomainCore.Common.DocumentStores.DocumentFolder", "ParentFolder")
                        .WithMany()
            ...
            modelBuilder.Entity("DomainCore.Common.Invoices.Invoice", b =>
                {
                    b.HasOne("DomainCore.Common.BusinessPartners.BusinessPartner", "Buyer")
                        .WithMany()
            ...
            modelBuilder.Entity("DomainCore.Common.Invoices.InvoiceItem", b =>
                {
                    ...
                    b.HasOne("DomainCore.Common.Invoices.Invoice", "Invoice")
            ...
            modelBuilder.Entity("DomainCore.Common.Phonebooks.PhonebookDocument", b =>
                {
                    ...
                    b.HasOne("DomainCore.Common.Phonebooks.Phonebook", "Phonebook")
                        .WithMany()
            ...
            modelBuilder.Entity("DomainCore.Common.ToDos.ToDo", b =>
                {
                    ...
                    b.HasOne("DomainCore.Common.ToDos.ToDoStatus", "ToDoStatus")
                        .WithMany()
