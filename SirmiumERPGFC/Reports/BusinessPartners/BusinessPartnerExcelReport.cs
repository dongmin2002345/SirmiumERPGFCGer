...
{
	public class BusinessPartnerExcelReport
	{
		public static void Show(List<BusinessPartnerViewModel> businessPartners, List<BusinessPartnerLocationViewModel> businessPartnerLocations)
		{
			...
			string[,] tabelaNasloviKolona = new string[,] { { "RB.", "ŠIFRA", "NAZIV KOMPANIJE", "MATIČNI BROJ", "PORESKI BROJ(PIB/JMBG)", "REGISTARSKI BROJ (PIO)", "PDV BROJ", "OPŠTINA", "GRAD", "ADRESA" } };
			...
			for (int i = 0; i < businessPartners?.Count; i++)
			{
				...
				sheet1.Cells[rowCounter, columnCounter].VerticalAlignment = XlVAlign.xlVAlignCenter;
				sheet1.Cells[rowCounter, columnCounter].Font.Size = 10;
				sheet1.Cells[rowCounter, columnCounter] = businessPartners[i].InternalCode;
				columnCounter++;
				...
				sheet1.Cells[rowCounter, columnCounter].VerticalAlignment = XlVAlign.xlVAlignCenter;
				sheet1.Cells[rowCounter, columnCounter].Font.Size = 10;
				sheet1.Cells[rowCounter, columnCounter] = businessPartners[i].IdentificationNumber;
				columnCounter++;

				sheet1.Cells[rowCounter, columnCounter].HorizontalAlignment = XlHAlign.xlHAlignCenter;
				sheet1.Cells[rowCounter, columnCounter].VerticalAlignment = XlVAlign.xlVAlignCenter;
				sheet1.Cells[rowCounter, columnCounter].Font.Size = 10;
				sheet1.Cells[rowCounter, columnCounter] = businessPartners[i].PIB;
				columnCounter++;

				sheet1.Cells[rowCounter, columnCounter].HorizontalAlignment = XlHAlign.xlHAlignCenter;
				sheet1.Cells[rowCounter, columnCounter].VerticalAlignment = XlVAlign.xlVAlignCenter;
				sheet1.Cells[rowCounter, columnCounter].Font.Size = 10;
				sheet1.Cells[rowCounter, columnCounter] = businessPartners[i].PIO;
				columnCounter++;
