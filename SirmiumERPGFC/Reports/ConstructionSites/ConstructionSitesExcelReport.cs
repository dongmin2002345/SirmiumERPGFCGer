...
namespace SirmiumERPGFC.Reports.ConstructionSites
{
	public class ConstructionSitesExcelReport
	{
		public static void Show(List<ConstructionSiteViewModel> constructionSites)
		{
			...
			string[,] tabelaNasloviKolona = new string[,] { { "RB.", "ŠIFRA GRADILIŠTA", "NAZIV GRADILIŠTA", "GRAD", "ADRESA", "MAKSIMALNI BROJ RADNIKA", "POČETAK UGOVORA", "ISTEK UGOVORA", "RAZLIKA VREDNOSTI" } };
