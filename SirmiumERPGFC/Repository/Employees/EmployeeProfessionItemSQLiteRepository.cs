...
namespace SirmiumERPGFC.Repository.Employees
{
    public class EmployeeProfessionItemSQLiteRepository
    {
        ...
        public EmployeeProfessionItemListResponse GetEmployeeItemsByEmployee(int companyId, Guid EmployeeIdentifier)
        {
            EmployeeProfessionItemListResponse response = new EmployeeProfessionItemListResponse();
            List<EmployeeProfessionItemViewModel> EmployeeItems = new List<EmployeeProfessionItemViewModel>();
            ...
            response.EmployeeProfessionItems = EmployeeItems;
            return response;
        }
