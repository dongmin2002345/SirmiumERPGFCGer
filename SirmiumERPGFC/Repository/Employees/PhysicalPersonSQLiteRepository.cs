...
namespace SirmiumERPGFC.Repository.Employees
{
	public class PhysicalPersonSQLiteRepository
	{
		...
		//public PhysicalPersonListResponse GetPhysicalPersonsNotOnConstructionSiteByPage(int companyId, Guid constructionSiteIdentifier, Guid businessPartnerIdentifier, PhysicalPersonViewModel PhysicalPersonSearchObject, int currentPage = 1, int itemsPerPage = 50)
		//{
		//	PhysicalPersonListResponse response = new PhysicalPersonListResponse();
		//	List<PhysicalPersonViewModel> PhysicalPersons = new List<PhysicalPersonViewModel>();
		...
		//				"WHERE Identifier NOT IN (SELECT PhysicalPersonIdentifier FROM PhysicalPersonByConstructionSites) " +
		//				"AND Identifier IN (Select PhysicalPersonIdentifier FROM PhysicalPersonByBusinessPartners WHERE BusinessPartnerIdentifier = @BusinessPartnerIdentifier) " +
		...
		//public PhysicalPersonListResponse GetPhysicalPersonsOnConstructionSiteByPage(int companyId, Guid constructionSiteIdentifier, PhysicalPersonViewModel PhysicalPersonSearchObject, int currentPage = 1, int itemsPerPage = 50)
		//{
		//	PhysicalPersonListResponse response = new PhysicalPersonListResponse();
		//	List<PhysicalPersonViewModel> PhysicalPersons = new List<PhysicalPersonViewModel>();
		...
		//				SqlCommandSelectPart +
		//				"FROM PhysicalPersons " +
		//				"WHERE Identifier IN (SELECT PhysicalPersonIdentifier FROM PhysicalPersonByConstructionSites WHERE ConstructionSiteIdentifier = @ConstructionSiteIdentifier) " +
		//				"AND (@Name IS NULL OR @Name = '' OR Name LIKE @Name) " +
		//				"AND (@SurName IS NULL OR @SurName = '' OR SurName LIKE @SurName) " +
		//				"AND (@Passport IS NULL OR @Passport = '' OR Passport LIKE @Passport) " +
		//				"AND CompanyId = @CompanyId " +
		...
		//#region PhysicalPersonByBusinessPartner (BusinessPartnerPhysicalPerson)

		//public PhysicalPersonListResponse GetPhysicalPersonsNotOnBusinessPartnerByPage(int companyId, Guid businessPartnerIdentifier, PhysicalPersonViewModel PhysicalPersonSearchObject, int currentPage = 1, int itemsPerPage = 50)
		//{
		//	PhysicalPersonListResponse response = new PhysicalPersonListResponse();
		//	List<PhysicalPersonViewModel> PhysicalPersons = new List<PhysicalPersonViewModel>();
		...
		//				SqlCommandSelectPart +
		//				"FROM PhysicalPersons " +
		//				"WHERE Identifier NOT IN (SELECT PhysicalPersonIdentifier FROM PhysicalPersonByBusinessPartners) " +
		...
		//				"SELECT Count(*) " +
		//				"FROM PhysicalPersons " +
		//				"WHERE Identifier NOT IN (SELECT PhysicalPersonIdentifier FROM PhysicalPersonByBusinessPartners WHERE BusinessPartnerIdentifier = @BusinessPartnerIdentifier) " +
		//				"AND (@Name IS NULL OR @Name = '' OR Name LIKE @Name) " +
		//				"AND (@SurName IS NULL OR @SurName = '' OR SurName LIKE @SurName) " +
		//				"AND (@Passport IS NULL OR @Passport = '' OR Passport LIKE @Passport) " +
		//				"AND CompanyId = @CompanyId;", db);
		...
		//public PhysicalPersonListResponse GetPhysicalPersonsOnBusinessPartnerByPage(int companyId, Guid businessPartnerIdentifier, PhysicalPersonViewModel PhysicalPersonSearchObject, int currentPage = 1, int itemsPerPage = 50)
		//{
		//	PhysicalPersonListResponse response = new PhysicalPersonListResponse();
		//	List<PhysicalPersonViewModel> PhysicalPersons = new List<PhysicalPersonViewModel>();
		...
		//				SqlCommandSelectPart +
		//				"FROM PhysicalPersons " +
		//				"WHERE Identifier IN (SELECT PhysicalPersonIdentifier FROM PhysicalPersonByBusinessPartners WHERE BusinessPartnerIdentifier = @BusinessPartnerIdentifier) " +
		//				"AND (@Name IS NULL OR @Name = '' OR Name LIKE @Name) " +
		//				"AND (@SurName IS NULL OR @SurName = '' OR SurName LIKE @SurName) " +
		//				"AND (@Passport IS NULL OR @Passport = '' OR Passport LIKE @Passport) " +
		//				"AND CompanyId = @CompanyId " +
		...
		public void Sync(IPhysicalPersonService PhysicalPersonService)
		{
			...
			if (response.Success)
			{
				List<PhysicalPersonViewModel> PhysicalPersonsFromDB = response.PhysicalPersons;
				foreach (var PhysicalPerson in PhysicalPersonsFromDB.OrderBy(x => x.Id))
				{
					Delete(PhysicalPerson.Identifier);
		...
		public PhysicalPersonResponse Create(PhysicalPersonViewModel PhysicalPerson)
		{
			...
			using (SqliteConnection db = new SqliteConnection("Filename=SirmiumERPGFC.db"))
			{
				...
				insertCommand.Parameters.AddWithValue("@UpdatedAt", PhysicalPerson.UpdatedAt);
		...
		public PhysicalPersonResponse UpdateSyncStatus(Guid identifier, int serverId, bool isSynced)
		{
			PhysicalPersonResponse response = new PhysicalPersonResponse();
