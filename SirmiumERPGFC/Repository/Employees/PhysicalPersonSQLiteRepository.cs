...
namespace SirmiumERPGFC.Repository.Employees
{
	public class PhysicalPersonSQLiteRepository
	{
        ...
        private SqliteCommand AddCreateParameters(SqliteCommand insertCommand, PhysicalPersonViewModel PhysicalPerson)
        {
            ...
            insertCommand.Parameters.AddWithValue("@CountryCode", ((object)PhysicalPerson.Country?.Mark) ?? DBNull.Value);
            ...
            insertCommand.Parameters.AddWithValue("@RegionCode", ((object)PhysicalPerson.Region?.RegionCode) ?? DBNull.Value);
            ...
            insertCommand.Parameters.AddWithValue("@MunicipalityCode", ((object)PhysicalPerson.Municipality?.MunicipalityCode) ?? DBNull.Value);
            ...
            insertCommand.Parameters.AddWithValue("@PassportCountryCode", ((object)PhysicalPerson.PassportCountry?.Mark) ?? DBNull.Value);
            ...
            insertCommand.Parameters.AddWithValue("@ResidenceCountryCode", ((object)PhysicalPerson.ResidenceCountry?.Mark) ?? DBNull.Value);
